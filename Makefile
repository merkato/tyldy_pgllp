...
SOURCES = \
	__init__.py \
	tyldy_pgllp.py tyldy_pgllp_dialog.py

PLUGINNAME = tyldy_pgllp

PY_FILES = \
	__init__.py \
	tyldy_pgllp.py tyldy_pgllp_dialog.py

UI_FILES = tyldy_pgllp_dialog_base.ui
...
QGISDIR=C:\Users\tomas\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
